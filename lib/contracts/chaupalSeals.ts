...
export const chaupalSealsAbi = [
  ...
  {
    "type": "event",
    "name": "StewardshipTransferStarted",
    "inputs": [
      {
        "name": "groupId",
        "type": "uint256",
...
export function getChaupalSealsAddress(): `0x${string}` {
  const address = process.env.NEXT_PUBLIC_SEALS_ADDRESS;
